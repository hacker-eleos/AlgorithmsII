...
public class FastPrefixTrieSET implements Iterable<String> {
    ...
    public static void main(String[] args) {
        FastPrefixTrieSET set = new FastPrefixTrieSET();
        while (!StdIn.isEmpty()) {
    ...
    /**
     * @param query
     * @return true if there exists string in dictionary which contains {@code query} as prefix
     * @throws IllegalArgumentException if {@code query} is {@code null}
     */
